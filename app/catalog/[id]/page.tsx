...
export default function CatalogPage() {
  ...
  async function loadProducts() {
    try {
      ...
      setProducts([]);
      setErrorText('Не вдалося завантажити каталог. Спробуйте ще раз.');
    } finally {
      setIsLoading(false);
    }
  }
          ...
          <section className={styles.products}>
            {isLoading ? (
              ...
              <div className={styles.stateBox}>
                <h2 className={styles.stateTitle}>Не вдалося завантажити каталог</h2>
                <p className={styles.stateText}>{errorText}</p>
                <button
                  type="button"
